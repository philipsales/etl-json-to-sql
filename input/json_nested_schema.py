    ...
    "address": {
      ...
      "properties": {
        "barangay": {
          ...
          "properties": {
            "purok": {
              "$id": "#/properties/address/properties/barangay/properties/purok",
              "type": "object",
              "title": "The Purok Schema",
              "default": "",
              "reqiured": [
                "street"
              ],
              "properties": {
                "street": {
                  "$id": "#/properties/address/properties/barangay/properties/purok/proprties/street",
                  "type": "string",
            ...
            "sitio": {
              "$id": "#/properties/address/properties/barangay/properties/sitio",
              "type": "string",
              "title": "The Sitio Schema",
              "default": "",
              "examples": [
                ""
              ],
